...
for i_stat = 1:length(set_of_status)
    ...
    the_filename = ['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_62_status_',sprintf('%.2f',the_status),'.mat'];
...
axis([0 8 0 0.03]), axis square, set(gca,'fontsize',14)
subplot(1,2,2)
xlabel('separation (cm)'), set(gca,'xtick',0:2:8)

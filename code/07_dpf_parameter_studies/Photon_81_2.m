...
plot(squeeze(db81.set_of__ds(db81.set_of_mua==mua,db81.set_of_mus==mus,:)),squeeze(db81.set_of_ODs(db81.set_of_mua==mua,db81.set_of_mus==mus,:)),'DisplayName','81',LineWidth=2), hold on
xlabel('SDS (cm)')
ylabel('OD (a.u.)')
set(gca,'fontsize',24')

...
dlta_d = 0.2; % in cm
n = 1.4; g = 0.95;
set_of_mua = (.05:.05:0.5);
set_of_mus = (050:050:500);
...
save('/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_33.mat','set_of_mua','set_of_mus','set_of__ds','set_of_ODs','set_of_DoR')
end

...
% this version: s vs. d for breast tissue (compression-induced hemodynamic changes in breast tissue: beam angle, 2-D measurement -> template)
...
for idx = 1
    ...
    for i_scale = 1:length(set_of_scal)
        ...
        save  (['Photon_28_X_',num2str(beam_X),'_Y_',num2str(beam_Y),'_phi_',num2str(beam_phi),'_tht_',num2str(beam_tht),'_sclae_',num2str(set_of_scal(i_scale)),'.mat' ], ...

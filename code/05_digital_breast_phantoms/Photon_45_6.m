...
% Similar to Photon_45_5: but in higher resolution
...
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(1,1),'DisplayName','data #1','LineStyle','none','Marker','none','MarkerFaceColor',get_color(5),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(2,1),'DisplayName','data #2','LineStyle','none','Marker','none','MarkerFaceColor',get_color(6),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(3,1),'DisplayName','data #3','LineStyle','none','Marker','none','MarkerFaceColor',get_color(7),'MarkerSize',12), hold on
...
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(1,2),'DisplayName','data #1','LineStyle','none','Marker','none','MarkerFaceColor',get_color(5),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(2,2),'DisplayName','data #2','LineStyle','none','Marker','none','MarkerFaceColor',get_color(6),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(3,2),'DisplayName','data #3','LineStyle','none','Marker','none','MarkerFaceColor',get_color(7),'MarkerSize',12), hold on
...
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(1,3),'DisplayName','data #1','LineStyle','none','Marker','none','MarkerFaceColor',get_color(5),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(2,3),'DisplayName','data #2','LineStyle','none','Marker','none','MarkerFaceColor',get_color(6),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(3,3),'DisplayName','data #3','LineStyle','none','Marker','none','MarkerFaceColor',get_color(7),'MarkerSize',12), hold on
...
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(1,4),'DisplayName','data #1','LineStyle','none','Marker','none','MarkerFaceColor',get_color(5),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(2,4),'DisplayName','data #2','LineStyle','none','Marker','none','MarkerFaceColor',get_color(6),'MarkerSize',12), hold on
plot(set_of_HCT_Cn,ones(size(set_of_mua)).*lit_data(3,4),'DisplayName','data #3','LineStyle','none','Marker','none','MarkerFaceColor',get_color(7),'MarkerSize',12), hold on
...
% OD vs mua (several d)
idx_d = 1:1:39; Y_Limit = [2 17]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_Pd = 1:3
    for i_d = 1:length(idx_d)% OD/mu/d vs mua (several d)
        ...
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
            ...
            plot(set_of_mua(idx_HCT_Cn),squeeze(nanmean(nanmean(y_temp,1),2)),'Color',TheColor,'DisplayName',['d = ',num2str(d_centers(idx_d(i_d)))],'LineWidth',2,'Marker','none','MarkerFaceColor',TheColor,'MarkerEdgeColor','none','LineStyle','-','MarkerSize',6), hold on
...
i_fig = 5; idx_d = 1:1:39; Y_Limit = [2 17]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
...
for i_Pd = 1:3
    for i_HCT = 1:length(idx_HCT_Cn)
        ...
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
            ...
            plot(d_centers(idx_d),squeeze(nanmean(nanmean(y_temp,1),2)),'Color',TheColor,'DisplayName',['\mu_a = ',num2str(set_of_mua(idx_HCT_Cn(i_HCT))),''],'LineWidth',2,'Marker','none','MarkerFaceColor',TheColor,'MarkerEdgeColor','none','LineStyle','-','MarkerSize',6), hold on
...
set_of_zdlim = nan(1,4);
i_fig = 90; idx_d = 1:1:39; Y_Limit = [2 17]; i_beam_X = 2; idx_HCT_Cn = 2:1:length(set_of_HCT_Cn);
for i_Tumr_Z = 1:length(set_of_Tumr_Z)
    % figure(i_fig), subplot(2,2,i_Tumr_Z)
    p_comp =     (set_of_I_s(:,:,i_beam_X,i_Tumr_Z,:,5,idx_d));
    y_refc = -log(set_of_I_s(:,:,i_beam_X,i_Tumr_Z,:,4,idx_d));
    y_temp = -log(set_of_I_s(:,:,i_beam_X,i_Tumr_Z,:,2,idx_d));
    y_temp(p_comp>p_threshold) = nan;

    y_temp = reshape(y_temp,length(set_of_percnt)*length(set_of_versns)*length(set_of_HCT_Cn),length(idx_d));
    [~,idx_min] = min(nanstd(y_temp,[],1)); set_of_zdlim(i_Tumr_Z) = d_centers(idx_d(idx_min));
    % do_shade(d_centers(idx_d),nanmean(y_temp,1),nanstd(y_temp,[],1),0.5,'b','std'), hold off
    % plot(d_centers(idx_d),nanstd(y_temp,[],1))
    xlabel('d (cm)'), xlim([min(d_centers) 3])
    ylabel('STD(OD) (a.u.)'), % ylim([min(Y_Limit) max(Y_Limit)])
    set(gca,'fontsize',12), % legend('show','numColumns',1,'Orientation','horizontal'),
    title(['beamX = ',num2str(set_of_beam_X(i_beam_X)),' cm, Tumor depth = ',num2str(set_of_Tumr_Z(i_Tumr_Z)),' cm'])
...
idx_d = 1:1:39; Y_Limit = [-4 +4]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_Pd = 1:3
    for i_d = 1:length(idx_d)
        TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
...
i_fig = 17; idx_d = 1:1:39; Y_Limit = [-4 +4]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_d = 1:length(idx_d)
    TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
    for i_Tumr_Z = 1:length(set_of_Tumr_Z)
        figure(i_fig), subplot(2,2,i_Tumr_Z)
...
idx_d = 1:1:39; Y_Limit = [0 50]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_Pd = 1:3
    for i_d = 1:length(idx_d)
        TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
            ...
            plot(set_of_mua(idx_HCT_Cn),squeeze(nanmean(nanmean(y_temp,1),2))./set_of_mua(idx_HCT_Cn).'./d_centers(idx_d(i_d)),'Color',TheColor,'DisplayName',['d = ',num2str(d_centers(idx_d(i_d)))],'LineWidth',2,'Marker','none','MarkerFaceColor',TheColor,'MarkerEdgeColor','none','LineStyle','-','MarkerSize',6), hold on
            xlabel('\mu_a (cm^{-1})'), xlim([min(set_of_mua) max(set_of_mua)])
...
i_fig = 25; idx_d = 1:1:39; Y_Limit = [0 50]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_d = 1:length(idx_d)
    TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
    for i_Tumr_Z = 1:length(set_of_Tumr_Z)
        figure(i_fig), subplot(2,2,i_Tumr_Z)
...
for i_Pd = 1:3
    for i_HCT = 1:length(idx_HCT_Cn)
        ...
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
            ...
            plot(d_centers(idx_d),squeeze(nanmean(nanmean(y_temp,1),2))./set_of_mua(idx_HCT_Cn(i_HCT))./d_centers(idx_d).','Color',TheColor,'DisplayName',['\mu_a = ',num2str(set_of_mua(idx_HCT_Cn(i_HCT))),''],'LineWidth',2,'Marker','none','MarkerFaceColor',TheColor,'MarkerEdgeColor','none','LineStyle','-','MarkerSize',6), hold on
            xlabel('d (cm)'), xlim([min(d_centers) 3])
...
% OD_relative vs mua (several d)
idx_d = 1:1:39; Y_Limit = [-0.5 +0.5]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_Pd = 1:3
    for i_d = 1:length(idx_d)
        TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
        for i_Tumr_Z = 1:length(set_of_Tumr_Z)
            ...
            plot(set_of_mua(idx_HCT_Cn),zeros(size(set_of_mua(idx_HCT_Cn))),  'Color','k','HandleVisibility','off','LineWidth',0.5,'LineStyle','--'), hold on
            plot(set_of_mua(idx_HCT_Cn),squeeze(nanmean(nanmean(y_temp,1),2))./d_centers(idx_d(i_d))./set_of_mua(idx_HCT_Cn).','Color',TheColor,'DisplayName',['d = ',num2str(d_centers(idx_d(i_d)))],'LineWidth',2,'Marker','none','MarkerFaceColor',TheColor,'MarkerEdgeColor','none','LineStyle','-','MarkerSize',6), hold on
            xlabel('\mu_a (cm^{-1})'), xlim([min(set_of_mua) max(set_of_mua)])
            ylabel('OD/\mu_a/d (cm)'), ylim([min(Y_Limit) max(Y_Limit)])
            set(gca,'fontsize',12), % legend('show','numColumns',1,'Orientation','horizontal'),
            title(['beamX = ',num2str(set_of_beam_X(i_beam_X)),' cm, Tumor depth = ',num2str(set_of_Tumr_Z(i_Tumr_Z)),' cm, Pd = ',num2str(set_of_percnt(i_Pd)),'%'])
...
i_fig = 33; idx_d = 1:1:39; Y_Limit = [-0.5 +0.5]; i_beam_X = 2; idx_HCT_Cn = 2:length(set_of_HCT_Cn);
for i_d = 1:length(idx_d)
    TheColor = [(i_d-1)/(length(idx_d)-1),0,1-(i_d-1)/(length(idx_d)-1)];
    for i_Tumr_Z = 1:length(set_of_Tumr_Z)
        figure(i_fig), subplot(2,2,i_Tumr_Z)
...
% set_of_zdlim = 0.*[0.11,0.98,1.28,1.42];
figure(101)
        ...
        for i_beam_X = 1:length(set_of_beam_X)
            for i_Tumr_Z = 1:length(set_of_Tumr_Z)
                for i_HCT_Cn = 1:length(set_of_HCT_Cn)
                    ...
                    plot(d_centers,y_comp,'r'), hold on
...
% shared dpf for each percentage
...
for i_percent = 1:length(set_of_percnt)
    for i_versns = 1:length(set_of_versns)
        for i_beam_X = 1:length(set_of_beam_X)
            for i_Tumr_Z = 1:length(set_of_Tumr_Z)
                for i_HCT_Cn = 1:length(set_of_HCT_Cn)
                    TheDPF = squeeze(mean(mean(set_of_DPF_s(i_percent,:,i_beam_X,i_Tumr_Z,i_HCT_Cn,:),2),1));
...
for i_beam_X = 2
    for i_Tumr_Z = 1:length(set_of_Tumr_Z)
        idx_of_d = (set_of_zdlim(i_Tumr_Z)<=d_centers & d_centers<=X_limit);
        TheColor = 'b';
        subplot(2,2,i_Tumr_Z)
        ...
        ylabel('rel. error (%)'), ylim([min(Y_Limit) max(Y_Limit)])
        set(gca,'fontsize',12), % legend('show','numColumns',1,'Orientation','horizontal'),
        title(['beamX = ',num2str(set_of_beam_X(i_beam_X)),' cm, Tumor depth = ',num2str(set_of_Tumr_Z(i_Tumr_Z)),' cm'])
...
for i_percent = 1:length(set_of_percnt)
    for i_versns = 1:length(set_of_versns)
        for i_beam_X = 1:length(set_of_beam_X)
            for i_Tumr_Z = 1:length(set_of_Tumr_Z)
                for i_HCT_Cn = 1:length(set_of_HCT_Cn)
                    TheDPF = squeeze(mean(mean(set_of_DPF_s(:,:,i_beam_X,i_Tumr_Z,i_HCT_Cn,:),2),1));
                    mua = -log(squeeze(set_of_I_s(i_percent,i_versns,i_beam_X,i_Tumr_Z,i_HCT_Cn,2,:)))./d_centers.'./TheDPF;
                    set_of_errrs(i_percent,i_versns,i_beam_X,i_Tumr_Z,i_HCT_Cn,:) = (mua-set_of_mua(i_HCT_Cn))./set_of_mua(i_HCT_Cn)*100;
                    clearvars TheColor TheDPF mua idx_of_d
                end
...
%                       percent      X     version      X     Beam_X       X     Tumor Z      X     HCT          X     N_bins
set_of_DPF_s = nan(size(set_of_I_s,1),size(set_of_I_s,2),size(set_of_I_s,3),size(set_of_I_s,4),size(set_of_I_s,5),size(set_of_I_s,7));
% set_of_zdlim = [0.11,0.98,1.28,1.42];
figure(103)
for i_percent = 1:length(set_of_percnt)
    for i_versns = 1:length(set_of_versns)
        for i_beam_X = 1:length(set_of_beam_X)
            for i_Tumr_Z = 1:length(set_of_Tumr_Z)
                for i_HCT_Cn = 1:length(set_of_HCT_Cn)
                    ...
                    set_of_DPF_s(i_percent,i_versns,i_beam_X,i_Tumr_Z,i_HCT_Cn,:) = -log(y_comp)./d_centers.'./set_of_mua(i_HCT_Cn);
                    plot(d_centers,y_comp,'r'), hold on
                    clearvars p_comp y_comp y_refc
                end
            end
        end
    end

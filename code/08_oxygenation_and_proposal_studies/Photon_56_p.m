    ...
    for i_BeamY = 1:length(set_of_beam_Y)
        for i_czs = 1:length(set_of_czs)
            for i_wvl = 1:length(set_of_wvl)
                ...
                the_filename = ['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_56_X_',num2str(beam_X),'_Y_',num2str(beam_Y),'_cz_',num2str(cz),'_wvlngth_',num2str(wvlngth),'.mat' ];
                ...
                if ~exist(the_filename,'file')
                    ...
                    disp(['Beam X = ',num2str(db.beam_X),', beam Y = ',num2str(db.beam_Y),', wvlngth = ',num2str(db.wvlngth),', dpth = ',num2str(db.cz),': # of photons = ',num2str(db.no_of_photons)])
                end

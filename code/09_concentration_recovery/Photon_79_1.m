...
for i_concentration = 1:length(set_of_concentration)
    ...
    disp(['C = ',num2str(the_concentration)])

    for i_rep = set_of_verse
        the_filename = ['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_79_concentration_',num2str(the_concentration),'_',num2str(i_rep),'.mat'];
    ...
    save  (['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_79_concentration_',num2str(the_concentration),'.mat'], ...

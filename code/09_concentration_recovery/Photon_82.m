...
% This Version: SAP experimental phantom (India ink tumor inclusion in gelatin 10%)
% Configuration:
%   Background: SAP hydrogel + TiO2 scattering matrix (1mg/mL)
...
% Based on Version 77, better optical properties (mu_a, mu_s, n, and g)
...
for i_concentration = 1:length(set_of_concentration)
    ...
    the_filename = ['Photon_82_concentration_',num2str(the_concentration),'.mat'];

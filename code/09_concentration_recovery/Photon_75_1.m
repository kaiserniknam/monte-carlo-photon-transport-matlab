...
SDS = 3; depth = 1.2;     % depth from top surface to circle center
% ================= Plot =================
clc
close all
...
for i_concentration = 1:length(set_of_concentration)
    ...
    the_filename = ['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_73_concentration_',num2str(the_concentration),'.mat' ];

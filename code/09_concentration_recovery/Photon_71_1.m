...
% Based on Version 65, better mu_a estimation
% analysis data
...
for i_concentration = 1:length(set_of_concentration)
    ...
    the_filename = ['/home/kaiser/BackUp/Dropbox/research/2.NIRs Project/code/DB/Photon_71_concentration_',num2str(the_concentration),'.mat' ];

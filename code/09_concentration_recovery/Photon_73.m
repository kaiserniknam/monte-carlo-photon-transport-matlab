...
%
%   New tumor depth = 1.60 cm / sds = 4 cm (previously 1.2 cm / sds = 3 cm).
%
%   Based on Version 70, extended to support unrestricted absorption coefficient (mu_a)
...
cx = 0.00; cy = 0.00; cz = 1.60; % Tumor depth from the skin (in cm)
...
for i_concentration = 1:length(set_of_concentration)
    ...
    the_filename = ['Photon_73_concentration_',num2str(the_concentration),'.mat' ];

...
%
%   Based on Version 69, extended to support unrestricted absorption coefficient (mu_a)clc
...
cx = 0.00; cy = 0.00; cz = 1.00; % Tumor depth from the skin (in cm)
...
for i_concentration = 1:length(set_of_concentration)
    ...
    the_filename = ['Photon_72_concentration_',num2str(the_concentration),'.mat' ];

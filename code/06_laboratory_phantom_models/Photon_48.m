...
% the same as Photon_47, but different optical properties
...
% Optical properties of TiO2 in agar (gelatin)
% Akarcay, et al. "Determining the optical properties of a gelatin-TiO2 phantom at 780 nm"
mua_TiO2 = 0.0053; mus_TiO2 = 2.86; g_TiO2 = 0.93; n_TiO2 = 1.36;
...
mua_indk = 32.4; mus_indk = 0.7; g_indk = 0.7; n_indk = 1.34;
...
for i_TiO2 = 1:length(set_of_TiO2)
    for i_indk = 1:length(set_of_indk)
        ...
        save  (['Photon_48_TiO2_',num2str(the_TiO2),'_Indik_',num2str(the_indk),'.mat' ], ...
            'p_in','w_in', ...
            'p_ot','w_ot', ...
            'T_mua_TiO2', 'T_mus_TiO2', 'T_g_TiO2', 'T_n_TiO2', ...
            'T_mua_indk', 'T_mus_indk', 'T_g_indk', 'T_n_indk', ...

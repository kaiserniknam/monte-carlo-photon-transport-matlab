...
% the same as Photon_48, but different optical properties for India Ink (constant mus, lower mua, higher g)
...
for i_TiO2 = 1:length(set_of_TiO2)
    for i_indk = 1:length(set_of_indk)
        ...
        save  (['Photon_50_TiO2_',num2str(the_TiO2),'_Indik_',num2str(the_indk),'.mat' ], ...
            'p_in','w_in', ...
            'p_ot','w_ot', ...
            'T_mua_TiO2', 'T_mus_TiO2', 'T_g_TiO2', 'T_n_TiO2', ...
            'T_mua_indk', 'T_mus_indk', 'T_g_indk', 'T_n_indk', ...
